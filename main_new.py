...
from utils.geometric import cropImage, getCloseCnts, superpixel, getMasked, checkNeigbors, getMedianColor
   ...
   # coord = ocr(ROI)
    ...
    for legend in json_data["shapes"]:
        ...
        if(typ=="line"):
            ...
            cnts = []
            r,g,b = getMedianColor(template)
            mask = getMasked(ROI,(r,g,b),MARGIN)>0
            curr_cnts = getROICnts(ROI*mask)
